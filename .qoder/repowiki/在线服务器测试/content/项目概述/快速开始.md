...
- 国内镜像：系统默认设置 HuggingFace 镜像地址，便于模型下载。
...
- 无结果回答：若检索不到相关内容，系统会提示“知识库中暂无匹配内容”，请确认文档已入库或调整问法。
