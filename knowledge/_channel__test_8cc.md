---
title: muduo/net/tests/Channel_test.cc
...
|                | Name           |
| -------------- | -------------- |
| void | **[print](/_channel__test_8cc.md#function-print)**(const char * msg) |
| int | **[main](/_channel__test_8cc.md#function-main)**(int argc, char * argv[]) |
