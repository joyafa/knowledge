---
title: muduo/net/InetAddress.cc
...
|                | Name           |
| -------------- | -------------- |
| const in_addr_t | **[kInaddrAny](/_inet_address_8cc.md#variable-kinaddrany)**  |
| const in_addr_t | **[kInaddrLoopback](/_inet_address_8cc.md#variable-kinaddrloopback)**  |
| __thread char[64 *1024] | **[t_resolveBuffer](/_inet_address_8cc.md#variable-t-resolvebuffer)**  |
...
### variable t_resolveBuffer

```cpp
static __thread char[64 *1024] t_resolveBuffer;
```
