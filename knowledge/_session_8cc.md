---
title: examples/memcached/server/Session.cc
...
|                | Name           |
| -------------- | -------------- |
| struct | **[Session::Reader](/struct_session_1_1_reader.md)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| bool | **[isBinaryProtocol](/_session_8cc.md#function-isbinaryprotocol)**(uint8_t firstByte) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| const int | **[kLongestKeySize](/_session_8cc.md#variable-klongestkeysize)**  |


## Functions Documentation

### function isBinaryProtocol

```cpp
static bool isBinaryProtocol(
    uint8_t firstByte
)
```
