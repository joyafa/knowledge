---
title: muduo/base/tests/TimeZone_unittest.cc
...
|                | Name           |
| -------------- | -------------- |
| struct tm | **[getTm](/_time_zone__unittest_8cc.md#function-gettm)**(int year, int month, int day, int hour, int minute, int seconds) |
| struct tm | **[getTm](/_time_zone__unittest_8cc.md#function-gettm)**(const char * str) |
| time_t | **[getGmt](/_time_zone__unittest_8cc.md#function-getgmt)**(int year, int month, int day, int hour, int minute, int seconds) |
| time_t | **[getGmt](/_time_zone__unittest_8cc.md#function-getgmt)**(const char * str) |
| void | **[test](/_time_zone__unittest_8cc.md#function-test)**(const [TimeZone](/class_time_zone.md) & tz, [TestCase](/struct_test_case.md) tc) |
| void | **[testNewYork](/_time_zone__unittest_8cc.md#function-testnewyork)**() |
| void | **[testLondon](/_time_zone__unittest_8cc.md#function-testlondon)**() |
| void | **[testHongKong](/_time_zone__unittest_8cc.md#function-testhongkong)**() |
| void | **[testSydney](/_time_zone__unittest_8cc.md#function-testsydney)**() |
| void | **[testUtc](/_time_zone__unittest_8cc.md#function-testutc)**() |
| void | **[testFixedTimezone](/_time_zone__unittest_8cc.md#function-testfixedtimezone)**() |
| void | **[testLosAngeles](/_time_zone__unittest_8cc.md#function-testlosangeles)**() |
| int | **[main](/_time_zone__unittest_8cc.md#function-main)**() |

## Attributes

|                | Name           |
| -------------- | -------------- |
| int | **[failure](/_time_zone__unittest_8cc.md#variable-failure)**  |
