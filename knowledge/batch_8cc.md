---
title: examples/sudoku/batch.cc
...
|                | Name           |
| -------------- | -------------- |
| typedef std::vector< string > | **[Input](/batch_8cc.md#typedef-input)**  |
| typedef std::shared_ptr< [Input](/batch_8cc.md#typedef-input) > | **[InputPtr](/batch_8cc.md#typedef-inputptr)**  |
| typedef std::function< void(const string &, double, int)> | **[DoneCallback](/batch_8cc.md#typedef-donecallback)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| bool | **[verify](/batch_8cc.md#function-verify)**(const string & result) |
| void | **[runLocal](/batch_8cc.md#function-runlocal)**(std::istream & in) |
| [InputPtr](/batch_8cc.md#typedef-inputptr) | **[readInput](/batch_8cc.md#function-readinput)**(std::istream & in) |
| void | **[done](/batch_8cc.md#function-done)**(const string & name, double elapsed, int count) |
| void | **[runClient](/batch_8cc.md#function-runclient)**(std::istream & in, const [InetAddress](/class_inet_address.md) & serverAddr, int conn) |
| int | **[main](/batch_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| [Timestamp](/class_timestamp.md) | **[g_start](/batch_8cc.md#variable-g-start)**  |
| int | **[g_connections](/batch_8cc.md#variable-g-connections)**  |
| int | **[g_finished](/batch_8cc.md#variable-g-finished)**  |
| [EventLoop](/class_event_loop.md) * | **[g_loop](/batch_8cc.md#variable-g-loop)**  |
