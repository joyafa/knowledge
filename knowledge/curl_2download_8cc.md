---
title: examples/curl/download.cc
...
|                | Name           |
| -------------- | -------------- |
| typedef std::shared_ptr< FILE > | **[FilePtr](/curl_2download_8cc.md#typedef-fileptr)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| template <int N\> <br>bool | **[startWith](/curl_2download_8cc.md#function-startwith)**(const string & str, const char(&) prefix[N]) |
| int | **[main](/curl_2download_8cc.md#function-main)**(int argc, char * argv[]) |
