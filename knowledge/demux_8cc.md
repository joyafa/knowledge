---
title: examples/multiplexer/demux.cc
...
|                | Name           |
| -------------- | -------------- |
| typedef std::shared_ptr< [TcpClient](/classmuduo_1_1net_1_1_tcp_client.md) > | **[TcpClientPtr](/demux_8cc.md#typedef-tcpclientptr)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| int | **[main](/demux_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| const size_t | **[kMaxPacketLen](/demux_8cc.md#variable-kmaxpacketlen)**  |
| const size_t | **[kHeaderLen](/demux_8cc.md#variable-kheaderlen)**  |
| const uint16_t | **[kListenPort](/demux_8cc.md#variable-klistenport)**  |
| const char * | **[socksIp](/demux_8cc.md#variable-socksip)**  |
| const uint16_t | **[kSocksPort](/demux_8cc.md#variable-ksocksport)**  |

## Types Documentation

### typedef TcpClientPtr
