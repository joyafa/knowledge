---
title: examples/fastcgi/fastcgi.cc
...
|                | Name           |
| -------------- | -------------- |
| struct | **[FastCgiCodec::RecordHeader](/struct_fast_cgi_codec_1_1_record_header.md)**  |

## Types

|                | Name           |
| -------------- | -------------- |
| enum| **[FcgiType](/fastcgi_8cc.md#enum-fcgitype)** { kFcgiInvalid = 0, kFcgiBeginRequest = 1, kFcgiAbortRequest = 2, kFcgiEndRequest = 3, kFcgiParams = 4, kFcgiStdin = 5, kFcgiStdout = 6, kFcgiStderr = 7, kFcgiData = 8, kFcgiGetValues = 9, kFcgiGetValuesResult = 10} |
| enum| **[FcgiRole](/fastcgi_8cc.md#enum-fcgirole)** { kFcgiResponder = 1, kFcgiAuthorizer = 2} |
| enum| **[FcgiConstant](/fastcgi_8cc.md#enum-fcgiconstant)** { kFcgiKeepConn = 1} |

## Functions

|                | Name           |
| -------------- | -------------- |
| uint16_t | **[readInt16](/fastcgi_8cc.md#function-readint16)**(const void * p) |
