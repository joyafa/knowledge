---
title: examples/fastcgi/fastcgi_test.cc
...
|                | Name           |
| -------------- | -------------- |
| void | **[onRequest](/fastcgi__test_8cc.md#function-onrequest)**(const [TcpConnectionPtr](/namespacemuduo_1_1net.md#typedef-tcpconnectionptr) & conn, [FastCgiCodec::ParamMap](/class_fast_cgi_codec.md#typedef-parammap) & params, [Buffer](/class_buffer.md) * in) |
| void | **[onConnection](/fastcgi__test_8cc.md#function-onconnection)**(const [TcpConnectionPtr](/namespacemuduo_1_1net.md#typedef-tcpconnectionptr) & conn) |
| int | **[main](/fastcgi__test_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| const string | **[kPath](/fastcgi__test_8cc.md#variable-kpath)**  |
