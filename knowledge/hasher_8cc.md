---
title: examples/wordcount/hasher.cc
...
|                | Name           |
| -------------- | -------------- |
| int | **[main](/hasher_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| size_t | **[g_batchSize](/hasher_8cc.md#variable-g-batchsize)**  |
| const size_t | **[kMaxHashSize](/hasher_8cc.md#variable-kmaxhashsize)**  |

## Defines

|                | Name           |
| -------------- | -------------- |
|  | **[__STDC_FORMAT_MACROS](/hasher_8cc.md#define---stdc-format-macros)**  |
