---
title: contrib/hiredis/mrediscli.cc
...
|                | Name           |
| -------------- | -------------- |
| string | **[toString](/mrediscli_8cc.md#function-tostring)**(long long value) |
| string | **[redisReplyToString](/mrediscli_8cc.md#function-redisreplytostring)**(const redisReply * reply) |
| void | **[connectCallback](/mrediscli_8cc.md#function-connectcallback)**([hiredis::Hiredis](/classhiredis_1_1_hiredis.md) * c, int status) |
| void | **[disconnectCallback](/mrediscli_8cc.md#function-disconnectcallback)**([hiredis::Hiredis](/classhiredis_1_1_hiredis.md) * c, int status) |
| void | **[timeCallback](/mrediscli_8cc.md#function-timecallback)**([hiredis::Hiredis](/classhiredis_1_1_hiredis.md) * c, redisReply * reply) |
| void | **[echoCallback](/mrediscli_8cc.md#function-echocallback)**([hiredis::Hiredis](/classhiredis_1_1_hiredis.md) * c, redisReply * reply, string * echo) |
| void | **[dbsizeCallback](/mrediscli_8cc.md#function-dbsizecallback)**([hiredis::Hiredis](/classhiredis_1_1_hiredis.md) * c, redisReply * reply) |
| void | **[selectCallback](/mrediscli_8cc.md#function-selectcallback)**([hiredis::Hiredis](/classhiredis_1_1_hiredis.md) * c, redisReply * reply, uint16_t * index) |
| void | **[authCallback](/mrediscli_8cc.md#function-authcallback)**([hiredis::Hiredis](/classhiredis_1_1_hiredis.md) * c, redisReply * reply, string * password) |
| void | **[echo](/mrediscli_8cc.md#function-echo)**([hiredis::Hiredis](/classhiredis_1_1_hiredis.md) * c, string * s) |
| int | **[main](/mrediscli_8cc.md#function-main)**(int argc, char ** argv) |
...
### function redisReplyToString

```cpp
string redisReplyToString(
