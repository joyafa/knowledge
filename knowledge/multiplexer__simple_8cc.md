---
title: examples/multiplexer/multiplexer_simple.cc
...
|                | Name           |
| -------------- | -------------- |
| int | **[main](/multiplexer__simple_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| const int | **[kMaxConns](/multiplexer__simple_8cc.md#variable-kmaxconns)**  |
| const size_t | **[kMaxPacketLen](/multiplexer__simple_8cc.md#variable-kmaxpacketlen)**  |
| const size_t | **[kHeaderLen](/multiplexer__simple_8cc.md#variable-kheaderlen)**  |
| const uint16_t | **[kClientPort](/multiplexer__simple_8cc.md#variable-kclientport)**  |
| const char * | **[backendIp](/multiplexer__simple_8cc.md#variable-backendip)**  |
| const uint16_t | **[kBackendPort](/multiplexer__simple_8cc.md#variable-kbackendport)**  |
...
```cpp
const int kMaxConns = 10;
```


### variable kMaxPacketLen
