---
title: examples/netty/echo/server.cc
...
|                | Name           |
| -------------- | -------------- |
| int | **[main](/netty_2echo_2server_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| int | **[numThreads](/netty_2echo_2server_8cc.md#variable-numthreads)**  |
