---
title: examples/sudoku/pipeline.cc
...
|                | Name           |
| -------------- | -------------- |
| typedef std::vector< string > | **[Input](/pipeline_8cc.md#typedef-input)**  |
| typedef std::shared_ptr< const [Input](/batch_8cc.md#typedef-input) > | **[InputPtr](/pipeline_8cc.md#typedef-inputptr)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| void | **[report](/pipeline_8cc.md#function-report)**(const std::vector< std::unique_ptr< [SudokuClient](/class_sudoku_client.md) > > & clients) |
| [InputPtr](/batch_8cc.md#typedef-inputptr) | **[readInput](/pipeline_8cc.md#function-readinput)**(std::istream & in) |
| void | **[runClient](/pipeline_8cc.md#function-runclient)**(const [InputPtr](/batch_8cc.md#typedef-inputptr) & input, const [InetAddress](/class_inet_address.md) & serverAddr, int conn, int pipelines, bool nodelay) |
| int | **[main](/pipeline_8cc.md#function-main)**(int argc, char * argv[]) |
...
```cpp
void report(
    const std::vector< std::unique_ptr< SudokuClient > > & clients
)
```
