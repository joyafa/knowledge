---
title: examples/roundtrip/roundtrip_udp.cc
...
|                | Name           |
| -------------- | -------------- |
| int | **[createNonblockingUDP](/roundtrip__udp_8cc.md#function-createnonblockingudp)**() |
| void | **[serverReadCallback](/roundtrip__udp_8cc.md#function-serverreadcallback)**(int sockfd, [muduo::Timestamp](/classmuduo_1_1_timestamp.md) receiveTime) |
| void | **[runServer](/roundtrip__udp_8cc.md#function-runserver)**(uint16_t port) |
| void | **[clientReadCallback](/roundtrip__udp_8cc.md#function-clientreadcallback)**(int sockfd, [muduo::Timestamp](/classmuduo_1_1_timestamp.md) receiveTime) |
| void | **[sendMyTime](/roundtrip__udp_8cc.md#function-sendmytime)**(int sockfd) |
| void | **[runClient](/roundtrip__udp_8cc.md#function-runclient)**(const char * ip, uint16_t port) |
| int | **[main](/roundtrip__udp_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| const size_t | **[frameLen](/roundtrip__udp_8cc.md#variable-framelen)**  |


## Functions Documentation

### function createNonblockingUDP
...
### function serverReadCallback

```cpp
void serverReadCallback(
    int sockfd,
