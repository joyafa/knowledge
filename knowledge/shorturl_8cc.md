---
title: examples/shorturl/shorturl.cc
...
|                | Name           |
| -------------- | -------------- |
| void | **[onRequest](/shorturl_8cc.md#function-onrequest)**(const [HttpRequest](/class_http_request.md) & req, [HttpResponse](/classmuduo_1_1net_1_1_http_response.md) * resp) |
| int | **[main](/shorturl_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| char[555] | **[favicon](/shorturl_8cc.md#variable-favicon)**  |
| bool | **[benchmark](/shorturl_8cc.md#variable-benchmark)**  |
| std::map< string, string > | **[redirections](/shorturl_8cc.md#variable-redirections)**  |
