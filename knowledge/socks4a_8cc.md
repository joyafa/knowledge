---
title: examples/socks4a/socks4a.cc
...
|                | Name           |
| -------------- | -------------- |
| void | **[onServerConnection](/socks4a_8cc.md#function-onserverconnection)**(const [TcpConnectionPtr](/namespacemuduo_1_1net.md#typedef-tcpconnectionptr) & conn) |
| void | **[onServerMessage](/socks4a_8cc.md#function-onservermessage)**(const [TcpConnectionPtr](/namespacemuduo_1_1net.md#typedef-tcpconnectionptr) & conn, [Buffer](/class_buffer.md) * buf, [Timestamp](/class_timestamp.md) ) |
| int | **[main](/socks4a_8cc.md#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| [EventLoop](/class_event_loop.md) * | **[g_eventLoop](/socks4a_8cc.md#variable-g-eventloop)**  |
| std::map< string, [TunnelPtr](/tunnel_8h.md#typedef-tunnelptr) > | **[g_tunnels](/socks4a_8cc.md#variable-g-tunnels)**  |
