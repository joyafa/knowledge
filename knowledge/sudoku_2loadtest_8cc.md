---
title: examples/sudoku/loadtest.cc
...
|                | Name           |
| -------------- | -------------- |
| typedef std::vector< string > | **[Input](/sudoku_2loadtest_8cc.md#typedef-input)**  |
| typedef std::shared_ptr< const [Input](/batch_8cc.md#typedef-input) > | **[InputPtr](/sudoku_2loadtest_8cc.md#typedef-inputptr)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| [InputPtr](/batch_8cc.md#typedef-inputptr) | **[readInput](/sudoku_2loadtest_8cc.md#function-readinput)**(std::istream & in) |
| int | **[main](/sudoku_2loadtest_8cc.md#function-main)**(int argc, char * argv[]) |
