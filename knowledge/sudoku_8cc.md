---
title: examples/sudoku/sudoku.cc
...
|                | Name           |
| -------------- | -------------- |
| typedef [Node](/struct_node.md) | **[Column](/sudoku_8cc.md#typedef-column)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| string | **[solveSudoku](/sudoku_8cc.md#function-solvesudoku)**(const [StringPiece](/classmuduo_1_1_string_piece.md) & puzzle) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| const int | **[kMaxNodes](/sudoku_8cc.md#variable-kmaxnodes)**  |
| const int | **[kRow](/sudoku_8cc.md#variable-krow)**  |
| const int | **[kCol](/sudoku_8cc.md#variable-kcol)**  |
| const int | **[kBox](/sudoku_8cc.md#variable-kbox)**  |
| const char[] | **[kNoSolution](/sudoku_8cc.md#variable-knosolution)**  |
