---
title: examples/ace/ttcp/ttcp_asio_async.cc
...
|                | Name           |
| -------------- | -------------- |
| typedef std::shared_ptr< [TtcpServerConnection](/class_ttcp_server_connection.md) > | **[TtcpServerConnectionPtr](/ttcp__asio__async_8cc.md#typedef-ttcpserverconnectionptr)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| void | **[transmit](/ttcp__asio__async_8cc.md#function-transmit)**(const [Options](/struct_options.md) & opt) |
| void | **[doAccept](/ttcp__asio__async_8cc.md#function-doaccept)**(tcp::acceptor & acceptor) |
| void | **[receive](/ttcp__asio__async_8cc.md#function-receive)**(const [Options](/struct_options.md) & opt) |

## Types Documentation

### typedef TtcpServerConnectionPtr
