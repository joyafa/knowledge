---
title: examples/ace/ttcp/ttcp_blocking.cc
...
|                | Name           |
| -------------- | -------------- |
| int | **[acceptOrDie](/ttcp__blocking_8cc.md#function-acceptordie)**(uint16_t port) |
| int | **[write_n](/ttcp__blocking_8cc.md#function-write-n)**(int sockfd, const void * buf, int length) |
| int | **[read_n](/ttcp__blocking_8cc.md#function-read-n)**(int sockfd, void * buf, int length) |
| void | **[transmit](/ttcp__blocking_8cc.md#function-transmit)**(const [Options](/struct_options.md) & opt) |
| void | **[receive](/ttcp__blocking_8cc.md#function-receive)**(const [Options](/struct_options.md) & opt) |


## Functions Documentation

### function acceptOrDie

```cpp
static int acceptOrDie(
    uint16_t port
)
```
